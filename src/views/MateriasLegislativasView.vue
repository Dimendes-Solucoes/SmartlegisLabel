    ...
    <div v-else class="space-y-4">
      ...
      >
        ...
        <div class="flex gap-3 justify-end">
          <button 
            @click.stop="baixarDocumentoMateria(materia)"
...
const baixarDocumentoMateria = (materia) => {
  if (!materia.attachment) {
    alert('Esta matéria não possui arquivo anexo.')
    return
  }
  const urlCompleta = materia.attachment.startsWith('http') 
    ? materia.attachment 
    : S3_HOST + materia.attachment

  baixarArquivoViaLink(urlCompleta)
}
